...
/**
 * The persistent class for the pagos_cuota database table.
 * 
 */
@Entity
@Table(name="pagos_cuota")
@NamedQuery(name="PagosCuota.findAll", query="SELECT p FROM PagosCuota p")
public class PagosCuota implements Serializable {
