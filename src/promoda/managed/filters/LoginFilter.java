package promoda.managed.filters;
...
import promoda.managed.beans.BeanLogueo;
...
public class LoginFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		BeanLogueo loginBean = (BeanLogueo) req.getSession().getAttribute(
				"beanLogueo");
	...
	private boolean noProteger(String urlStr) {
		 ...
		 */
		  ...
		  if (urlStr.indexOf("/javax.faces.resource/") != -1)
		    return true;
		  if(urlStr.endsWith("captura.png"))
			  return true;
		  if(urlStr.endsWith("banner_up.jpg"))
			  return true;
		  if(urlStr.endsWith("fondo.jpg"))
			  return true;
		  ...
		  if(urlStr.contentEquals("includes"))
			  return true;
		  if(urlStr.contentEquals("estilo.css"))
			  return true;
		  return false;
	}
